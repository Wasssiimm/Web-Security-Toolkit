      ...
      <Panel className="p-7">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-[#f2f2f2]">Strength and Breach Check</h1>
            <p className="text-sm text-gray-600 dark:text-[#888] mt-2 leading-relaxed max-w-2xl">
              ...
              Breach checks use <span className="font-mono-cyber text-lime-700 dark:text-lime-400">k-anonymity</span>: only
